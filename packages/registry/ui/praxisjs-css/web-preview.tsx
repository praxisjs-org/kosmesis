...
class WebPreviewStyles extends Stylesheet {
  $root = this.css({
    display: "flex",
    gap: "0.75rem",
    borderRadius: "0.5rem",
...
@Component()
export class WebPreview extends StatelessComponent<WebPreviewProps> {
  @Styled(WebPreviewStyles) $s!: WebPreviewStyles;
  ...
  render() {
    ...
    return (
      <a href={url} target="_blank" rel="noopener noreferrer" data-slot="web-preview" class={cx(this.$s.$root, cls)}>
