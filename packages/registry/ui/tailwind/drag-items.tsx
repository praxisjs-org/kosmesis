...
export class DragItems extends StatelessComponent<DragItemsProps> {
  render() {
    ...
    return (
      <div id={id} data-slot="drag-items" class={cn("relative size-full", cls)}>
        {children}
      </div>
    );
  }
  ...
  render() {
    return (
      <div
        ...
        class={cn(
          "absolute cursor-grab touch-none select-none data-dragging:z-50 data-dragging:cursor-grabbing",
          this.class,
        )}
