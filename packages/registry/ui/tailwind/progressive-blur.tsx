...
const SIDE_CLASS: Record<ProgressiveBlurSide, string> = {
...
export class ProgressiveBlur extends StatelessComponent<ProgressiveBlurProps> {
  render() {
    ...
    return (
      <div aria-hidden class={cn("pointer-events-none absolute", SIDE_CLASS[side], cls)} style={{ ...sizeStyle, ...crossInsetStyle }}>
