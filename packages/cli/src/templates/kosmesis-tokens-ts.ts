/**
 * Source written to the `@praxisjs/css` theme module (default path: `src/lib/kosmesis-theme.ts`)
...
// tries to override border-color on a specific element — a real risk if this project ever loads
// Tailwind CSS alongside this style system's reset.
globalStyle(
  (css) =>
    css({})
      .on("*", {
