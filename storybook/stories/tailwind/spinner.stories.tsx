...
import { Spinner, type SpinnerProps } from "@/ui/tailwind/spinner";

type Args = Pick<SpinnerProps, "aria-label">;

const meta: Meta<Args> = {
  title: "Tailwind/Spinner",
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
        component:
          ...
          "`aria-busy=\"true\"`, empty `<span>`). The spin animation is pure Tailwind (`animate-spin`).",
      },
    },
  },
  argTypes: {
