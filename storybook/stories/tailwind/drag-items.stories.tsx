...
import { DragItem, DragItems } from "@/ui/tailwind/drag-items";

const meta: Meta = {
  title: "Tailwind/Drag Items",
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
      ...
      <div style="width:420px;height:220px;border:1px dashed var(--border);border-radius:8px;font-family:sans-serif">
        <DragItems>
          <DragItem defaultPosition={{ x: 24, y: 24 }}>
            <div style="display:flex;size:64px;width:64px;height:64px;align-items:center;justify-content:center;border-radius:8px;background:var(--primary);color:var(--primary-foreground);font-size:.8rem">
              A
            </div>
          </DragItem>
