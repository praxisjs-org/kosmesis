...
import { Ticket } from "@/ui/tailwind/ticket";
    ...
    docs: {
      description: {
        story:
          ...
          "top/bottom edge at the seam (relies on sitting on the page background, same as `bg-background` anywhere else in this registry).",
      },
    },
  },
  render: () => (
