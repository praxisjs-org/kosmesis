...
import { Checkbox, type CheckboxProps } from "@/ui/tailwind/checkbox";
    ...
    docs: {
      description: {
        component:
          ...
          "`data-indeterminate`), rendering a `✓`/`–` glyph via a Tailwind `after:content-[...]` " +
          "pseudo-element rather than an inline SVG icon.",
      },
    },
  },
  argTypes: {
