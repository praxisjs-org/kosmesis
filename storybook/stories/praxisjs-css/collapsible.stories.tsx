...
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@/ui/praxisjs-css/collapsible";
      ...
      <div style="width:280px">
        <Collapsible>
          ...
          <div style="margin-top:8px">
            <CollapsibleTrigger disclosure={this.collapsible} class={this.$s.$trigger}>
              Toggle more
            </CollapsibleTrigger>
          </div>
