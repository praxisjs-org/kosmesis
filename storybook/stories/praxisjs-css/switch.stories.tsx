...
import { Switch, type SwitchProps } from "@/ui/praxisjs-css/switch";

type Args = Pick<SwitchProps, "checked" | "disabled">;

const meta: Meta<Args> = {
  title: "PraxisCSS/Switch",
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
        component:
          ...
          "root — `$thumb`'s `.on(\"[data-checked] &\", ...)` is the `@praxisjs/css` equivalent of " +
          "Tailwind's `in-data-checked:` variant.",
      },
    },
  },
  argTypes: {
