...
import { Badge, type BadgeProps } from "@/ui/praxisjs-css/badge";
    ...
    docs: {
      description: {
        component:
          ...
          "via the `as` prop, styled with `@Styled(BadgeStyles)` fields built on Kosmesis design tokens.",
      },
    },
  },
  argTypes: {
